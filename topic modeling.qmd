...
```{r}
corpus <- Corpus(VectorSource(movie_data$Plot))  # Replace 'plot' with your actual column name
...
wordcloud(words = topic1_words$term, freq = topic1_words$beta, min.freq = 1, 
